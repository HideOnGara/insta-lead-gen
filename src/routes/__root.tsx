...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "FocuLead analiza miles de perfiles de Instagram con IA, puntúa los mejores leads para tu negocio y genera el primer DM personalizado." },
      ...
      { name: "twitter:description", content: "FocuLead analiza miles de perfiles de Instagram con IA, puntúa los mejores leads para tu negocio y genera el primer DM personalizado." },
